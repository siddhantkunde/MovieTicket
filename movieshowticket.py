# -*- coding: utf-8 -*-
"""MovieShowTicket.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kmpkvNlTYli72TgpQgbuvgifgyCY0pEh
"""
    ...
    if x == 1:
        ...
        if Row_number in range(1, Row+1) and Column_number in range(1, Seats+1):
            if table_of_chart[str(Row_number-1)][str(Column_number)] == 'S':
                ...
                person_detail = {}
                if conform == 'yes':
                    person_detail['Name'] = input('Your Name - ')
                    person_detail['Gender'] = input(' Gender - ')
                    person_detail['Age'] = input(' Age - ')
                    person_detail['Phone_No'] = input(' Phone number - ')
                    person_detail['Ticket_prize'] = prize_of_ticket
                    table_of_chart[str(Row_number-1)][str(Column_number)] = 'B'
                    Booked_Seat += 1
                    Income += prize_of_ticket
                else:
                    continue
